...
Была проведена комплексная аналитическая работа с набором данных, в
результате которой получены количественные характеристики выборки
персонажей. Работа подтвердила закрепление умений применять ключевые
функции dplyr для решения реальных задач по извлечению, преобразованию и
обобщению информации из структурированных данных.
