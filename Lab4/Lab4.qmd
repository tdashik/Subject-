...
Лабораторная работа была успешно выполнена, что подтверждается комплексным анализом DNS-трафика с использованием языка R и экосистемы tidyverse. На практике закреплены навыки загрузки, предобработки и исследования структурированных сетевых логов. С помощью функций dplyr и tidyr были решены аналитические задачи: определен состав участников сети, выявлены наиболее активные узлы и популярные домены, вычислены статистические характеристики временных интервалов запросов. Работа также включила интеграцию с внешним API для получения геолокационных данных, что продемонстрировало навыки работы с сетевыми запросами в R.

# Вывод

В ходе исследования DNS-логов были получены значимые результаты, описывающие сетевую активность организации. Определено соотношение внутренних и внешних участников обмена, выявлены топовые источники запросов и целевые домены. Полученные навыки могут быть использованы для мониторинга и расследования инцидентов в реальных условиях.